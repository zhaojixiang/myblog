...
<section>
    <header>
        <div class="quotes">
            ...
            <div class="flower"><img src="../../assets/blog/images/flower.jpg"></div>
        </div>
        <!--nav begin-->
        <div id="nav">
            <ul>
    ...
    <div class="photowall">
        <ul class="wall_a">
            <li><a href="/"><img src="../../assets/blog/images/p01.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
            <li><a href="/"><img src="../../assets/blog/images/p02.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
            <li><a href="/"><img src="../../assets/blog/images/p03.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
            ...
            <li><a href="/"><img src="../../assets/blog/images/p04.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
            ...
            <li><a href="/"><img src="../../assets/blog/images/p05.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
            <li><a href="/"><img src="../../assets/blog/images/p06.jpg">
      <figcaption>
        <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
      </figcaption>
      </a></li>
    ...
    <div class="about">
        <ul>
            ...
            <div class="about_girl"><span><a href="/"><img src="../../assets/blog/images/girl.jpg"></a></span>
                <p>初遇时，他的幽默，他往日的深情、承诺和傻劲儿，两个人共度的美丽时刻，一一印在我的回忆里....</p>
            </div>
            <div class="about_boy"><span><a href="/"><img src="../../assets/blog/images/boy.jpg"></a></span>
    ...
    <div class="blog">
        <figure>
            <a href="/"><img src="../../assets/blog/images/t01.jpg"></a>
...
body {
    font-size: 12px;
    background: #226039 url(../../assets/blog/images/bg.jpg) center 0 scroll no-repeat;
    color: #5d5d5d;
}
...
.flower {
    ...
    right: 0;
    top: 60px;
    background: url(../../assets/blog/images/flower.png) no-repeat;
    width: 173px;
    height: 175px;
    z-index: 2
}
...
#nav ul {
    width: 1000px;
    margin: auto;
    /* background: url(../../assets/blog/images/heart.png) left no-repeat; */
    overflow: hidden
}
...
.photowall {
    ...
    padding: 30px 0;
    overflow: hidden;
    border-bottom: #226039 1px solid
}
...
.about_girl span img, .about_boy span img {
    width: 130px;
    height: 130px;
    border-radius: 100%
}

.about_girl, .about_boy {
    width: 100%;
    margin: 10px auto 0;
    overflow: hidden
}
...
.about_girl p {
    ...
    border-radius: 6px;
    position: relative;
    box-shadow: inset #226039 -1px -1px 1px;
    text-shadow: #226039 1px 1px 0px
}
...
.about_girl p::before {
    ...
    border-color: transparent #559664 transparent;
    position: absolute;
    left: -20px;
    top: 24px;
}
...
.hope ul {
    width: 1000px;
    margin: auto;
    background: url(../../assets/blog/images/love.png) no-repeat left center;
    overflow: hidden
}
